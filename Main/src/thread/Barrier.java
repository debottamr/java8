...
{ 
    ...
    { 
        ...
        System.out.println("Is the barrier broken? - " + Barrier.newBarrier.isBroken()); 
        sum = 10 + 20; 
        try
        { 
        	Barrier.newBarrier.await(3000, TimeUnit.MILLISECONDS); 
          
            // number of parties waiting at the barrier 
            System.out.println("Number of parties waiting at the barrier "+ 
            "at this point = " + Barrier.newBarrier.getNumberWaiting()); 
        }  
        catch (InterruptedException | BrokenBarrierException e)  
        { 
            e.printStackTrace(); 
